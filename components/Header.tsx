...
export default function Header() {
  ...
  return (
    <header className="z-[999] flex px-4 py-2 items-center leading-[0.2rem] justify-between fixed  top-0 left-0 right-0 h-[3.8rem] bg-white bg-opacity-90 "> 
...
export default function Header() {
  ...
  <div className="flex flex-row fixed top-0 left-0 right-0 h-[4.5rem] border border-white border-opacity-40 bg-white bg-opacity-80 ">
